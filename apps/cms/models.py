...
class HomePage(models.Model):
    ...
    incubator_youtube_url = models.URLField(blank=True, null=True, help_text="YouTube video URL (e.g. https://youtu.be/XXXXX)")
    incubator_stat_1_value = models.CharField(max_length=20, default="5+")
    incubator_stat_1_label = models.CharField(max_length=50, default="Cohorts Completed")
    incubator_stat_2_value = models.CharField(max_length=20, default="120+")
    incubator_stat_2_label = models.CharField(max_length=50, default="Startups Launched")
    incubator_stat_3_value = models.CharField(max_length=20, default="50+")
    incubator_stat_3_label = models.CharField(max_length=50, default="Expert Mentors")
    incubator_stat_4_value = models.CharField(max_length=20, default="78%")
    incubator_stat_4_label = models.CharField(max_length=50, default="Success Rate")
