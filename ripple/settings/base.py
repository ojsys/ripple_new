...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["auth", "accounts", "apps.projects", "apps.funding", "apps.srt", "apps.cms"],
    "icons": {
        ...
        "apps_projects.Project": "fas fa-project-diagram",
        "apps_projects.Category": "fas fa-tags",
        "apps_projects.FundingType": "fas fa-money-bill",
        "apps_funding.Investment": "fas fa-hand-holding-usd",
        "apps_funding.Pledge": "fas fa-donate",
        "apps_projects.Reward": "fas fa-gift",
        "apps_srt.Venture": "fas fa-rocket",
        "apps_srt.PartnerProfile": "fas fa-handshake",
        "apps_cms.SiteSettings": "fas fa-cog",
    },
